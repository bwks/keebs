...
keyboard.keymap = [
    [   # Layer 0
        ...
        KC.MO(2),    KC.Z,        KC.X,            KC.C,           KC.V,         KC.B,                                            KC.N,         KC.M,        KC.COMM,       KC.DOT,       KC.SLSH,        XXXXX,
                                  XXXXX,           XXXXX,          KC.LCTRL,     KC.LSHIFT,      KC.LCTRL,         KC.LALT,       KC.ENTER,     KC.SPACE,    XXXXX,         XXXXX,
    ...
    [   # Layer 1
        ...
        XXXXX,       XXXXX,       NVIM_CLOSE,      XXXXX,          MEHS,          XXXXX,                                          HASH_BRACKET,   XXXXX,       LEFT_ARROW,    RIGHT_ARROW,    XXXXX,          KC.DF(0),
                                  XXXXX,           XXXXX,          KC.LCTRL,      KC.LSHIFT,      KC.LCTRL,        KC.LALT,       KC.ENTER,       KC.SPACE,    KC.F11,        KC.F12,
    ...
    [   # Layer 2
        ...
        XXXXX,       XXXXX,       XXXXX,           XXXXX,          XXXXX,         XXXXX,                                          XXXXX,          XXXXX,       XXXXX,         XXXXX,          XXXXX,          KC.DF(0),
                                  XXXXX,           XXXXX,          KC.LCTRL,      KC.LSHIFT,       KC.LCTRL,       KC.LALT,       XXXXX,          XXXXX,       XXXXX,         XXXXX,          
