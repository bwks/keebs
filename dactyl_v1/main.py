...
keyboard.keymap = [
    ...
    [
        ...
        XXXXX,       VIM_QUIT,    VIM_WR_QUIT,     KC.ESC,         XXXXX,        XXXXX,        KC.MINUS,       KC.EQUAL,    KC.UP,         KC.LBRACKET,    KC.RBRACKET,    XXXXX,
        XXXXX,       VIM_WR,      HASH_BRACKET,    XXXXX,          MEH,          XXXXX,        HASH_ROCKET,    KC.LEFT,     KC.DOWN,       KC.RIGHT,       WALRUS,         XXXXX,
