...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /*=======, =======, =======, =======, =======, =======, =======, -- <L R> --  =======, =======, =======, =======, =======, =======, =======,*/
      ...
      XXXXXXX, XXXXXXX, KC_NO,   KC_NO,   KC_LCTL, KC_LSFT, KC_LCTL, /* <L R> */  KC_LALT, KC_ENT,  KC_SPC,  KC_NO,   KC_NO,   XXXXXXX, XXXXXXX,
    ...
    /*=======, =======, =======, =======, =======, =======, =======, -- <L R> --  =======, =======, =======, =======, =======, =======, =======,*/
      XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   XXXXXXX, /* <L R> */  XXXXXXX, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_BSPC, 
      XXXXXXX, VIM_QIT, VIM_WRQ, KC_ESC,  VIM_RQT, KC_NO,   XXXXXXX, /* <L R> */  XXXXXXX, KC_EQL,  KC_MINS, KC_UP,   KC_LBRC, KC_RBRC, KC_BSLS, 
      ...
      XXXXXXX, XXXXXXX, KC_NO,   KC_NO,   KC_LCTL, KC_LSFT, KC_LCTL, /* <L R> */  KC_LALT, KC_ENT,  KC_SPC,  KC_F11,  KC_F12,  XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, KC_LGUI, /* <L R> */  KC_LGUI, KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    /*=======, =======, =======, =======, =======, =======, =======, -- <L R> --  =======, =======, =======, =======, =======, =======, =======,*/
    ),
    ...
    /*=======, =======, =======, =======, =======, =======, =======, -- <L R> --  =======, =======, =======, =======, =======, =======, =======,*/
      ...
      XXXXXXX, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   XXXXXXX, /* <L R> */  XXXXXXX, KC_NO,   KC_NO,   KC_PGUP, KC_NO,   KC_NO,   KC_NO, 
      XXXXXXX, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   XXXXXXX, /* <L R> */  XXXXXXX, KC_NO,   KC_HOME, KC_PGDN, KC_END,  KC_NO,   KC_NO, 
      XXXXXXX, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   XXXXXXX, /* <L R> */  XXXXXXX, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   DF(LR0),  
      XXXXXXX, XXXXXXX, KC_NO,   KC_NO,   KC_LCTL, KC_LSFT, KC_LCTL, /* <L R> */  KC_LALT, KC_ENT,  KC_SPC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LALT, KC_LGUI, /* <L R> */  KC_LGUI, KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    /*=======, =======, =======, =======, =======, =======, =======, -- <L R> --  =======, =======, =======, =======, =======, =======, =======,*/
    ),
